...
<body>
	...
	<spring:hasBindErrors name="movimentacaoErrors">
		...
		<form:form action="${spring:mvcUrl('MC#altera').build()}" method="post" commandName="movimentacao">
			...
			<button type="submit" value="Alterar" class="btn btn-primary">ALTERAR MONEY!!</button>
